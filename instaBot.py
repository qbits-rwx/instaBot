...
class Bot:
    ...
    comments = [
        "lecker!",
        "Das sieht gut aus. Muss ich unbedingt auch ausprobieren! :)",
    ]
    ...
    def login(self, username, password):
        ...
        sleep(5)
        insta_cookies = self.driver.find_element(
            By.XPATH,
        ...
        self.driver.find_element(
            By.XPATH,
            '//*[@id="mount_0_0_BB"]/div/div/div[1]/div/div/div/div[1]/div[1]/div[2]/section/main/div/div/div/div/div',
        ).click()  # clicking 'Jetzt nicht btn'
        sleep(2)
        ...
        for hashtag in hashtags:
            ...
            for link in self.links:
                ...
                try:
                    ...
                    self.driver.find_element(
                        By.XPATH, "//button/div/div[contains(text(), 'Folgen')]"
                    ).click()
                except:
                    pass
                # comment
